...
extension HGError {
    /// Returns whether the HGError is an invalid URL error.
    public var isInvalidURLError: Bool {
        if case .invalidURL = self { return true }
        return false
    }
    
    /// Returns whether the HGError is a parameter encoding error. When `true`, the `underlyingError` property will
    ...
    /// Returns whether the HGError is a multipart encoding error. When `true`, the `url` and `underlyingError` properties
    ...
    /// Returns whether the `HGError` is a response validation error. When `true`, the `acceptableContentTypes`,
    ...
    /// Returns whether the `HGError` is a response serialization error. When `true`, the `failedStringEncoding` and
...
extension HGError.ParameterEncodingFailureReason {
...
extension HGError.MultipartEncodingFailureReason {
    var url: URL? {
        switch self {
...
extension HGError.ResponseValidationFailureReason {
...
extension HGError.ResponseSerializationFailureReason {
