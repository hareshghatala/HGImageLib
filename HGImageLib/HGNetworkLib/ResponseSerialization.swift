...
extension Request {
    ...
    public static func serializeResponseData(response: HTTPURLResponse?, data: Data?, error: Error?) -> Result<Data> {
        ...
        guard let validData = data else {
            return .failure(HGError.responseSerializationFailed(reason: .inputDataNil))
        }
    ...
    public static func dataResponseSerializer() -> DownloadResponseSerializer<Data> {
        return DownloadResponseSerializer { _, response, fileURL, error in
            ...
            guard let fileURL = fileURL else {
                return .failure(HGError.responseSerializationFailed(reason: .inputFileNil))
            }
            ...
            do {
                ...
                return .failure(HGError.responseSerializationFailed(reason: .inputFileReadFailed(at: fileURL)))
            }
        }
    }
...
extension Request {
        ...
        -> Result<String>
    {
        ...
        if let string = String(data: validData, encoding: actualEncoding) {
            ...
            return .failure(HGError.responseSerializationFailed(reason: .stringSerializationFailed(encoding: actualEncoding)))
        }
    }
}
...
extension Request {
        ...
        -> Result<Any>
    {
        ...
        guard let validData = data, validData.count > 0 else {
            return .failure(HGError.responseSerializationFailed(reason: .inputDataNilOrZeroLength))
        }
        ...
        do {
            ...
            return .failure(HGError.responseSerializationFailed(reason: .jsonSerializationFailed(error: error)))
        }
    }
}
...
extension Request {
        ...
        -> Result<Any>
    {
        ...
        do {
            ...
            return .failure(HGError.responseSerializationFailed(reason: .propertyListSerializationFailed(error: error)))
        }
    }
}
