...
extension UIButton {
    ...
    private struct AssociatedKey {
        static var imageDownloader = "hg_UIButton.ImageDownloader"
        static var sharedImageDownloader = "hg_UIButton.SharedImageDownloader"
        static var imageReceipts = "hg_UIButton.ImageReceipts"
        static var backgroundImageReceipts = "hg_UIButton.BackgroundImageReceipts"
    }
        ...
        completion: ((DataResponse<UIImage>) -> Void)? = nil)
    {
        ...
        hg_cancelImageRequest(for: state)
        
        let imageDownloader = hg_imageDownloader ?? UIButton.hg_sharedImageDownloader
    ...
    public func hg_cancelImageRequest(for state: ControlState) {
    ...
    public func hg_setBackgroundImage(
        for state: ControlState,
        url: URL,
        placeholderImage: UIImage? = nil,
        filter: ImageFilter? = nil,
        ...
        completion: ((DataResponse<UIImage>) -> Void)? = nil)
    {
        ...
        hg_cancelBackgroundImageRequest(for: state)
    ...
    public func hg_cancelBackgroundImageRequest(for state: ControlState) {
